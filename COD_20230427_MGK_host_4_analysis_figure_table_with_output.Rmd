...
```{r}
phyloseq$phyloseq_count %>%
    subset_samples(baylor_other_id %in% c("lyPMA_neg_3", "lyPMA_pos_5")) %>%
    {
        data <- .
        ...
        otu_table %>%
        data.frame() %>%
        write.csv(., "Project_SICAS2_microbiome/5_Scripts/MGK/Host_depletion_git/data/DAT_20241115_MGK_host_lyPMA_neg_3_and_lyPMA_pos_5.csv")
