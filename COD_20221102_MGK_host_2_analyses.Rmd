---
title: "COD_20221129_MGK_host_2_QC"
...
str_libraries <- c(
    ...
    "lme4", "lmerTest", "writexl", "harrietr", "Maaslin2"
)
...
# Initail QC --------------------------------------------------------------
        ...
        phyloseq_control_nomock <- subset_samples(phyloseq_control_nomock, sample_data(phyloseq_control_nomock)$sample_type != "mock")
subset_samples(phyloseq_control_nomock, sample_data(phyloseq_control_nomock)$sample_type != "mock")
