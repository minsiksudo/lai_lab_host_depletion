---
title: "COD_20230301_SICAS2_AIM1_unfiltered"
author: "Minsik Kim"
date: "2023-03-14"
output:
    rmdformats::downcute:
...
sample_data(phyloseq) <- sample_data(phyloseq) %>% data.frame(check.names = F) %>% 
        mutate(treatment = tolower(treatment), 
               ...
               sample_type = factor(sample_type, levels = c("BAL", "nasal_swab", "Sputum", "neg_extraction", "pos_extraction", "neg_depletion", "pos_depletion"))) %>%
        sample_data()
```
