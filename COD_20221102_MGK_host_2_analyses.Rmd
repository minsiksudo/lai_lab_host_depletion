...
ggballoonplot(merge(fit_data_neg$rel %>%
                            gather(treatment, value, Control:QIAamp, factor_key=TRUE),
                    fit_data_neg$data_italic %>%
                            rownames_to_column("feature") %>%
                            gather(treatment, qval, lyPMA:QIAamp, factor_key=TRUE),
                    by.x = c('feature', 'treatment'), by.y = c('feature', 'treatment'), all = T),
              size = "value", fill = "qval", y = "feature", x= "treatment") +
        theme_classic(base_family = "serif") +
...
```{r warning=FALSE, message=FALSE}
ggballoonplot(merge(fit_data_pos$rel %>%
                            gather(treatment, value, Control:QIAamp, factor_key=TRUE),
...
```{r warning=FALSE, message=FALSE}
ggballoonplot(merge(fit_data_bal$rel %>%
                            gather(treatment, value, Control:QIAamp, factor_key=TRUE),
...
```{r warning=FALSE, message=FALSE}
ggballoonplot(merge(fit_data_ns$rel %>%
                            gather(treatment, value, Control:QIAamp, factor_key=TRUE),
...
ggballoonplot(merge(fit_data_spt$rel %>%
                            gather(treatment, value, Control:QIAamp, factor_key=TRUE),
