...
#glmer_libfail_nasal <- glmer(lib_failed ~ treatment + (1|subject_id),
#                             data = sample_data %>%
#                                     data.frame %>%
      ...
      cbind("Nasal",
        ...
        data_frame %>% 
               ...
               "97.5%" = "X97.5..") %>% 
                ...
                subset(treatment %in% c("Untreated", "lyPMA", "Benzonase",
                                      "HostZERO", "MolYsis", "QIAamp"))
} %>%
        ...
        scale_color_manual(values = c("#e31a1c","#fb9a99","#33a02c",
                                      "#b2df8a","#1f78b4","#a6cee3"),
                           name = "Treatment",
                           breaks = c("Untreated", "lyPMA", "Benzonase",
...
```{r}
a <- lmer(dist ~ treatment + (1|subject_id),
     data = path_horn_dist_long_within_sampleid_from_control %>%
             subset(sample_type == "BAL")) %>% 
        summary %>%
        .$ coefficients %>% 
...
b <- lmer(dist ~ treatment + (1|subject_id),
     data = path_horn_dist_long_within_sampleid_from_control %>%
             subset(sample_type == "Nasal")) %>% 
        summary %>%
        .$ coefficients %>% 
...
c <- lmer(dist ~ treatment + (1|subject_id),
     data = path_horn_dist_long_within_sampleid_from_control %>%
             subset(sample_type == "Sputum")) %>% 
        summary %>%
        .$ coefficients %>% 
...
horn_perm_inter <- vegan::adonis2(distance(phyloseq_rel_nz, method="horn") ~ sample_type * treatment + subject_id,
                                  data = phyloseq_rel_nz %>% sample_data %>% data.frame(check.names = F), 
...
summary_bal <- matrix(nrow=5,ncol=0) %>% data.frame() %>% 
        rownames_to_column("Sample type") %>% mutate(`Sample type` = "BAL",
                                           Method = c("lyPMA", "Benzonase", "HostZERO", "MolYsis", "QIAamp"),
                                           `%Host DNA` = c("-3.1",
                                                           "-1.1",
                                                           "-18.3*",
                                                           "-17.7*",
                                                           "-6.3"),
                                           `log10(Final reads)` = c("0.4",
                                                           "0.8*",
                                                           "1.0**",
                                                           "1.0**",
                                                           "1.0**"),
                                           `Species richness` = c("1.8",
                                                           "5.2",
                                                           "8.4",
                                                           "18.4**",
                                                           "9.0"),
                                           `Function Richness` = c("59",
                                                           "126*",
                                                           "165**",
                                                           "190***",
                                                           "130*"),
                                           `Bias (Morishita-Horn)` = c("0.32*",
                                                           "0.11",
                                                           "0.27",
                                                           "0.20",
                                                           "0.25"),
                                           `% gram negative` = c("6.42",
                                                           "15.33",
                                                           "8.61",
                                                           "-0.86",
                                                           "7.31"),
                                           `Comment` = c("Low efficiency",
                                                           "Low efficiency",
                                                           "No incrased richness",
                                                           "Optimal",
                                                           "")) 
                                           
summary_ns <- matrix(nrow=5,ncol=0) %>% data.frame() %>% 
        rownames_to_column("Sample type") %>% mutate(`Sample type` = "Nasal swab",
                                           Method = c("lyPMA", "Benzonase", "HostZERO", "MolYsis", "QIAamp"),
                                           `%Host DNA` = c("-27.7*",
                                                           "-20.0",
                                                           "-73.6***",
                                                           "-50.6***",
                                                           "-75.4***"),
                                           `log10(Final reads)` = c("-0.5*",
                                                           "0.1",
                                                           "0.9**",
                                                           "0.2",
                                                           "1.1***"),
                                           `Species richness` = c("-4.5",
                                                           "-0.1",
                                                           "10.3***",
                                                           "6.3*",
                                                           "7.5**"),
                                           `Function Richness` = c("9",
                                                           "23",
                                                           "66***",
                                                           "64**",
                                                           "66***"),
                                           `Bias (Morishita-Horn)` = c("0.17*",
                                                           "0.16*",
                                                           "0.05",
                                                           "0.22**",
                                                           "0.13"),
                                           `% gram negative` = c("19.41**",
                                                           "1.89",
                                                           "0.03",
                                                           "2.28",
                                                           "0.13"),
                                           `Comment` = c("No incrased richness",
                                                           "Low efficiency",
                                                           "High rate of library prep failure",
                                                           "High rate of library prep failure",
                                                           "Optimal")) 
                                           

summary_spt <- matrix(nrow=5,ncol=0) %>% data.frame() %>% 
        rownames_to_column("Sample type") %>% mutate(`Sample type` = "Sputum",
                                           Method = c("lyPMA", "Benzonase", "HostZERO", "MolYsis", "QIAamp"),
                                           `%Host DNA` = c("-3.8",
                                                           "-6.3",
                                                           "-45.5***",
                                           ...
                                           `Function Richness` = c("80*",
                                                           ...
                                                           "142***",
                                                           "116***"),
                                           `Bias (Morishita-Horn)` = c("0.35**",
                                                           "0.52***",
                                                           "0.61***",
                                                           "0.60***",
                                                           "0.62***"),
                                           `% gram negative` = c("-40.92***",
                                                           "-52.49***",
                                                           "-59.87***",
                                                           "-59.87***",
                                                           "-60.59***"),
...
table3 <- rbind(summary_bal, summary_ns, summary_spt) %>% 
        kbl(format = "html", escape = 0) %>%
