...
As some of the species richenss got way higher, this data cannot be used for alpha diversity indices.
...
ggarrange(f10a, f10b, common.legend = T, ncol = 1)
...
figa1 <- ggarrange(fd1, fd2, ncol = 1, common.legend = T, align = "hv")
...
figA2 <- ggarrange(figd2a, figd2b, common.legend = T, nrow = 2)
figA2
...
horn_perm_all <- vegan::adonis2(distance(phyloseq_tv, method="bray") ~ sample_type * treatment + subject_id + log10(Final_reads),
                                  data = phyloseq_tv %>% sample_data %>% data.frame(check.names = F),
                                  permutations = 10000)
