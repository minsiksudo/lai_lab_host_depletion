...
ng_to_bp_constant <- 1.096e-21  # g/bp constant
...
qPCR_wide_copies <- qPCR_wide_dna_amount_g %>%
        mutate(ALL = ALL / (g_to_bp_constant * genome_size),
               FROZEN = FROZEN / (g_to_bp_constant * genome_size),
               PELLET = PELLET / (g_to_bp_constant * genome_size),
               SUPERNATANT = SUPERNATANT / (g_to_bp_constant * genome_size))

# this is genome copy per / uL
qPCR_cells <- qPCR_wide_copies %>%
