...
path_working <- "/Users/minsikkim/Dropbox (Partners HealthCare)/Project_SICAS2_microbiome/5_Scripts/MGK/Host_depletion_git"
path_library <- "/Library/Frameworks/R.framework/Resources/library"
str_libraries <- c("readxl", "phyloseq", "tidyverse", "pacman", "yaml", "ggplot2", "vegan", "microbiome", "ggpubr", "viridis", "decontam", "gridExtra", "ggpubr", "lme4", "lmerTest", "writexl", "harrietr", "Maaslin2", "ggtext", "ggpmisc", "gridExtra", "gamm4", "reshape2", "kableExtra", "knitr", "ggtree")
...
## Species richness (all samples) {.tabset}
...
Most of the DA taxa were **sample type** dependent.
...
ggplot(maaslin_interaction, aes(y = -log10(qval), x = coef, col = metadata)) +
         ...
         theme(legend.position = "top", axis.title.y = ggtext::element_markdown()) +
         scale_color_manual(values = c("#e41a1c",  "#377eb8", "#4daf4a", "#984ea3")) +
         guides(col = guide_legend(title = "Fixed effects", title.position = "top"))
...
## Function richness (all samples) {.tabset}
...
### Function richness (all samples) - ANOVA
...
## Burger-Parker index Function {.tabset}
...
### Function strata term (detailed treatment)
