...
#path_rpk2 <- read.csv("20230401/humann3/PathAbundance.relab.metagenome.txt", sep = "\t", check.names = F, row.names = "# Pathway") %>% select(-c("taxonomy"))
#path_tax2 <- read.csv("20230401/humann3/PathAbundance.relab.metagenome.txt", sep = "\t", check.names = F) %>%
#        select(c("taxonomy", "# Pathway")) %>% rename(pathway = "# Pathway", group = "taxonomy")
