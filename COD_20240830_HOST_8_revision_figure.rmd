...
## Calculating rarecurve with step = 1 {.tabset}
...
### Calculating rarecurve with step = 1

```{r}
set.seed(seed)

rare_microbe_1 <- phyloseq.extended::ggrare(phyloseq_nz_microbe,
                          step = 1, color = "treatment", label = "subject_id", se = T)

# rare_function <- phyloseq.extended::ggrare(phyloseq_nz_function,
#                           step = 100000, color = "treatment", label = "subject_id", se = T)

rare_v_1 <- phyloseq.extended::ggrare(phyloseq_nz_v,
                          step = 1, color = "treatment", label = "subject_id", se = T)

```


## Calculating rarecurve with step = 20 

```{r}
set.seed(seed)

rare_microbe_20 <- phyloseq.extended::ggrare(phyloseq_nz_microbe,
                          step = 20, color = "treatment", label = "subject_id", se = T)

# rare_function <- phyloseq.extended::ggrare(phyloseq_nz_function,
#                           step = 100000, color = "treatment", label = "subject_id", se = T)

rare_v_20 <- phyloseq.extended::ggrare(phyloseq_nz_v,
                          step = 20, color = "treatment", label = "subject_id", se = T)

```


## Calculating rarecurve with step = 100

```{r}
set.seed(seed)


rare_microbe_100 <- phyloseq.extended::ggrare(phyloseq_nz_microbe,
                          step = 100, color = "treatment", label = "subject_id", se = T)

# rare_function <- phyloseq.extended::ggrare(phyloseq_nz_function,
#                           step = 100000, color = "treatment", label = "subject_id", se = T)

rare_v_100 <- phyloseq.extended::ggrare(phyloseq_nz_v,
                          step = 100, color = "treatment", label = "subject_id", se = T)
