...
filt_maaslin_all_v_h$group <-  ifelse(filt_maaslin_all_v_h$Estimate > 0.5 & filt_maaslin_all_v_h$qval < 0.1, "more",
                     ifelse(filt_maaslin_all_v_h$Estimate < (-0.5) & filt_maaslin_all_v_h$qval < 0.1, "less",
                            "insignificant"))
