...
picogreen <- 
        rbind(read_excel("/Users/minsikkim/Dropbox (Partners HealthCare)/Project_Baylor/4_Data/1_Raw/Baylor_Processed/20221102_PQ00331_Host_Depletion/DAR_20230629_JJC_PQ00331 PICO data_NA_library_concentrations.xlsx",
                         sheet = 1,
                         skip = 2), 
                   read_excel("/Users/minsikkim/Dropbox (Partners HealthCare)/Project_Baylor/4_Data/1_Raw/Baylor_Processed/20230124_PQ00430_sicas2_nasal_host_depleted/DAR_20230629_JJC_PQ00430 PICO dataNA_library_concentrations.xlsx",
                              sheet = 1) %>%
                      select(c("Sample", "Well", "Concentration (ng/ul)"))
              ) %>%
        subset(., !is.na(.$Sample)) %>% 
        rename(sequencing_id = "Sample", picogreen_ng_ul = "Concentration (ng/ul)") %>% 
        select(c("sequencing_id", "picogreen_ng_ul"))
